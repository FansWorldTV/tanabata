...
public class YoutubeUpload {
     ...
     */
    public static void upload(final String filepath, final String title, final String description, final List<String> tags, final JTextArea txtlog, final DefaultListModel list) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    txtlog.append("Uploading: " + filepath + "\n");
                    ...
                    txtlog.append("Upload complete!\n");
                    String videolink = "http://www.youtube.com/watch?v=" + returnedVideo.getId();
                    txtlog.append("Link: " + videolink + "\n");
                    list.addElement(videolink);
