...
public class YoutubeUpload {
     ...
     */
    public static void upload(String filepath, String title, String description, List<String> tags, JTextArea txtlog) {
        ...
        try {
            ...
            txtlog.append("Link: " + "http://www.youtube.com/watch?v=" + returnedVideo.getId() + "\n");
